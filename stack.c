...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            scanf("%s", infix);
            printf("postfix expression = %s", infix_to_postfix(infix, postfix));
            break;
...
void infix_to_prefix(char infix[], char prefix[])
{
    ...
    rev_infix[j] = '\0';
    // printf("%s   ",rev_infix); strcpy(prefix,infix_to_postfix(rev_infix,prefix));
    // printf("%s   ",prefix);
